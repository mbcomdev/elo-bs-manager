 ...
 *
 * @class sol.common.IxConnectionUtils
 * @singleton
 * @eloix
 *
 */
sol.define("sol.common.IxConnectionUtils", {
  ...
  getConnection: function (asAdmin) {
    var me = this;
    return (asAdmin == true && me.isAdminConnectionAvailable()) ? ixConnectAdmin : ixConnect;
  },

  getAdminConnection: function() {
    var me = this;
    if (!me.isAdminConnectionAvailable()) {
      throw Error("admin connection is not available");
    }
    return me.getConnection(true);
  },

  isAdminConnectionAvailable: function() {
